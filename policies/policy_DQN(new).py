...
class Model():
    ...
    def __init__(self, instance, policy_info, state_dim):
        ...
        self.exploration_rate_decay = 0.995 if 'exploration_rate_decay' not in policy_info else policy_info['exploration_rate_decay'] # default: 0.995 (multiplicative decay factor) 
    ...
    def update_parameter(self):
        ...
        # update exploration rate (multiplicative decay)
